...
<html>
  ...
  <body>
  	<%-- <jsp:include page="/WEB-INF/include/header.jsp" /> --%>
		...
		<div class="kjtx-news">
			<p class="content-title">${partners.name }</p>
			<p class="news-title">
	    		发稿时间：<span datetime="1419234974257" style="font-weight:normal" class="title-date">
	    		<date:date parttern="yyyy-MM-dd" value="${news.editTime }"></date:date></span>
	    		&nbsp;&nbsp;&nbsp;来源：跨界天下
	   		</p>
